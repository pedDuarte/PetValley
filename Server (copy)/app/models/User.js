...
var User = {
    ...
    addUser : function(user, callback){
        return connection.query("INSER INTO USER VALUES(CODE_CPF, NAME, SURNAME, BIRTHDATE, SEX, EMAIL, PASSWORD, CREATE_TIME, CELLPHONE, PHONENUMBER, IMAGE, ID_ADDRESS_FK) values;"
        ,[user.cpf,user.name],callback)
    },   
